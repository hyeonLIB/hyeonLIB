...
def update_data(selected_datas):
    ...
    return selected_datas, columns, df_viewer.to_dict('records'), dpdn_col_selection, [], sel_table_data
...
def cell_clicked(active_cell, columns_data):
    ...
    if active_cell["column_id"] == 'col_type':
        ...
        # Numeric variable
            ...
            return modal_children, no_update, 'lg', {'col_name':selected_column,'col_type':'numeric'}
    else:

...
@callback(
    ...
    State(component_id='__init__',component_property='data'),
)
def check(n_clicks, initp):
    print(n_clicks, initp)
    
    from app import main_dataframe
    print(main_dataframe)
    return no_update

# @callback(
#     Output(component_id='next-page1', component_property='n_clicks'),
#     Input(component_id='__init__',component_property='data'),
# )
# def test(init):
#     import pages.data_import1
#     main_dataframe = pages.data_import1.main_dataframe
#     # print(main_dataframe)
#     return no_update
